...
class MethodChannelFirebaseTestlabDetector extends FirebaseTestlabDetectorPlatform {
  ...
  Future<bool?> isAppRunningInTestlab() async {
    final isRunningInTestlab = await methodChannel.invokeMethod<bool>('isAppRunningInTestlab');
